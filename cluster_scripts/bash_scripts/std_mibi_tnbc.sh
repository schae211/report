#!/bin/bash
#SBATCH --job-name=mibi-tnbc
#SBATCH -t 23:30:00
#SBATCH --nodes=1
#SBATCH --cpus-per-task=16
#SBATCH --partition=single
#SBATCH --output=/net/data.isilon/ag-saez/bq_pschaefer/LOGS/mibi_tnbc_%j.log
...
# Run Rscript
Rscript /net/data.isilon/ag-saez/bq_pschaefer/SCRIPTS/benchmark/std_mibi_tnbc.R $1
