...
# Run Rscript
echo "Rscript /net/data.isilon/ag-saez/bq_pschaefer/report/cluster_scripts/$FILE $ARG1 $ARG2"
Rscript /net/data.isilon/ag-saez/bq_pschaefer/report/cluster_scripts/$FILE $ARG1 $ARG2