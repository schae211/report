#!/bin/bash
#SBATCH --job-name=rf_hyper
#SBATCH -t 23:50:00
#SBATCH --nodes=1
#SBATCH --cpus-per-task=16
#SBATCH --partition=single
#SBATCH --output=/net/data.isilon/ag-saez/bq_pschaefer/LOGS/rf_hyper%j.log
...
# Run Rscript
Rscript /net/data.isilon/ag-saez/bq_pschaefer/SCRIPTS/hyperparameter/rf_mibi_tnbc.R $1
