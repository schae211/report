...
##### Verbosity ##### 
print("Four I Analysis, Low Resolution")
...
output.path <- "/net/data.isilon/ag-saez/bq_pschaefer/OUTPUT/4iANCA/ratio_24/"
...
##### Input ##### 
print("Reading Data")
misty.views.smp <- readRDS(paste0(input.path, "ratio_24_views.RDS"))
