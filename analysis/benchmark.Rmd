...
Since the runtime is the biggest issue for the MLP model, I tested all backpropagation implemented in `RSNNS` but this did not really help to increase the runtime very much. In fact the default algorithm "Std_Backpropagation" is almost the fastest.
