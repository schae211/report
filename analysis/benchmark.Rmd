...
Function to get splits according to view and sample from misty importances.
...
Function to compute the cosine similarity given a tibble of vectors, where
...
Function to compute the jaccard index given a tibble of vectors, where
each column represents a vector. Indices are harcoded.
